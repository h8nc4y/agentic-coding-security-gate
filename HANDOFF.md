...
- T-001〜T-015: done。最新状態は `TASKS_BACKLOG.md` が正本。
...
| 種別 | コマンド | 結果 |
| --- | --- | --- |
| scanner tests | `pwsh -NoProfile -ExecutionPolicy Bypass -File .\tests\scan-private-markers.Tests.ps1` | pass。25 tests passed |
